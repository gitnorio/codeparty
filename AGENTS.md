...
61. [UX] Always make the landing-page primary CTA session-aware: show GitHub login when signed out, onboarding continuation for incomplete profiles, and dashboard access for completed profiles.
